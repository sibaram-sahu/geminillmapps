...
def get_vector_store(text_chunks):
    ...
    vecotr_store = FAISS.from_texts(text_chunks, embedding=embeddings)
    vecotr_store.save_local("faiss_index")
...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        pdf_docs = st.file_uploader("Upload the PDF files and click submit & process", accept_multiple_files=True)
